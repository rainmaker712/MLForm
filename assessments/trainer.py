...
class DeepSpeedTrainer:
    ...
    def train(self):
        ...
        #                         One of hte things that you will need to initialize are the cmd_args 
        #                         Please pass them theorugh the Trainer Config 
        ...
        def run_epoch(loader, is_train):
            ...
            for it, (x, y) in pbar:
                ...
                x = x.to(self.config.cmd_args.local_rank)
                y = y.to(self.config.cmd_args.local_rank)
